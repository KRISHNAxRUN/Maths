from telegram import Update, InlineKeyboardButton, InlineKeyboardMarkup from telegram.ext import ApplicationBuilder, CommandHandler, ContextTypes

BOT_TOKEN = "8405058082:AAFyfgpmbec8iTUpfnPDhxUqKe3L9Zfr6RM"

async def start(update: Update, context: ContextTypes.DEFAULT_TYPE): keyboard = [ [InlineKeyboardButton("📘 Ex 1.1", url="https://youtu.be/nd8-akvdnIw?si=ZWA2qQPetHCBpJd5")], [InlineKeyboardButton("📘 Ex 1.2", url="https://youtu.be/uuKHJS8zudE?si=u1pXkePQJIsVxA1_")], [InlineKeyboardButton("📘 Ex 1.3", url="https://youtu.be/ccMvTsevjpo?si=Og8SxPgsXCXEQLrS")], [InlineKeyboardButton("📘 Ex 1.4", url="https://youtu.be/faklWT5XMPU?si=YLoJ3WAnHqe6VflE")], [InlineKeyboardButton("📘 Ex 1.5", url="https://youtu.be/YOJ3SzgDjiA?si=crq313yzm0Ez0kkW")],
...
app = ApplicationBuilder().token(BOT_TOKEN).build() app.add_handler(CommandHandler("start", start)) app.run_polling()
